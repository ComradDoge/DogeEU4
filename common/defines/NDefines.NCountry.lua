...
NDefines.NCountry.LEGITIMACY_DYNASTY_CHANGE = 30 --PGG Defines 20
NDefines.NCountry.POWER_MAX = 999

NDefines.NCountry.NAT_FOCUS_YEARS = 15 --PGG Defines 25
NDefines.NCountry.NAT_FOCUS_YEARS_RANK = 5 --PGG Defines

NDefines.NCountry.CALL_ALLY_DECLINE_PRESTIGE_PENALTY = 0 --PGG Defines -25
NDefines.NCountry.BREAK_VASSAL_PRESTIGE_PENALTY = -10 --PGG Defines -25

NDefines.NCountry.ABANDON_CORE_PRESTIGE = 0 --PGG Defines -10
NDefines.NCountry.CORE_LOSE_PRESTIGE = 0 --PGG Defines -10

NDefines.NCountry.PS_REPLACE_RIVAL = 50 --PGG Defines 100
