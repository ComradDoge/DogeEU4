...
-- Innovativeness
NDefines.NCountry.INNOVATIVENESS_FIRST_PICKED_IDEA = 0.5 -- 1.0
NDefines.NCountry.INNOVATIVENESS_DAYS_AFTER_FIRST_PICK_VIABLE = 60 --90
NDefines.NCountry.INNOVATIVENESS_FIRST_REACHED_TECH_LEVEL = 1.0 -- 2.0

-- Military
NDefines.NCountry.LAND_FORCELIMIT_EXTRA_COST_FACTOR = 6.0
NDefines.NCountry.NAVAL_FORCELIMIT_EXTRA_COST_FACTOR = 6.0
NDefines.NCountry.STARTING_ARMY_SIZE = 0.5 --.75
NDefines.NCountry.STARTING_FLEET_SIZE = 0.5 --.9
