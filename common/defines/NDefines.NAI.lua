...
NDefines.NAI.REPAY_LOAN_BASE_AI_DESIRE = 30	-- AI scoring for repaying loans, multiplied by (MAX(budget - other loans, 0) * number_of_loans)/cost
...
--NDefines.NAI.DIPLOMATIC_ACTION_OFFER_CONDOTTIERI_ONLY_MILITARY_RULERS = 0.9 --If set to 1, AI will only send Condottieri while having a miliaristic ruler.
--NDefines.NAI.DIPLOMATIC_ACTION_OFFER_CONDOTTIERI_ONLY_NEIGHBORS = 0.9 --If set to 1, AI will only send Condottieri to neighbors, regardless of access.
--NDefines.NAI.DIPLOMATIC_ACTION_GUARANTEE_POWERBALANCE_FACTOR = 50 --AI scoring for guarantee action is increased by this if a nation blocks a powerbalance threat.
